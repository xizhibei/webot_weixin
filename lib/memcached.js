...
var error = require('debug')('webot:lifeego:mc:error');
var log = require('debug')('webot:lifeego:log');
var verbose = require('debug')('webot:lifeego:verbose');

var mc = new Memcached(conf.memcached.hosts, conf.memcached.options);
verbose('begin to connect memcached');
...
verbose('Connect memcached finished');
